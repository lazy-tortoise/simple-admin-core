...
func (tc *TenantCreate) SetTenantID(i int) *TenantCreate {
	tc.mutation.SetTenantID(i)
	return tc
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (tc *TenantCreate) SetNillableTenantID(i *int) *TenantCreate {
	if i != nil {
		tc.SetTenantID(*i)
	}
	return tc
...
func (tc *TenantCreate) SetID(u uint64) *TenantCreate {
	tc.mutation.SetID(u)
	return tc
}
